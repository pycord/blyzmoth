...
pub fn header() -> Html {
    html! {
        <header class={classes!("sticky", "flex", "grid", "top-0", "z-top", "gap-2", "bg-white/80", "backdrop-blur-md", "py-2", "container", "text-not-quite-black")}>
...
pub fn home() -> Html {
    html! {
        <div class={classes!("relative", "font-brand", "antialiased", "overflow-hidden")}>
            <Header />
            <div class={classes!("mobile:px-20")}>
                <div class={classes!("text-not-quite-black", "text-center", "pt-20")}>
                ...
                <div class={classes!("flex", "justify-center", "items-center", "pt-10", "text-xl", "gap-x-8", "pb-28")}>
                    ...
                    <a href="https://github.com/Pycord-Development/pycord-v3">
                        <button class={classes!("transition", "duration-400", "text-not-quite-black", "bg-white", "border-not-quite-black", "border", "hover:text-white", "hover:bg-[#5865F2]", "hover:border-[#5865F2]", "delay-150", "rounded-full", "px-6", "py-2",)}>
                            {"View the Source"}
                        </button>
                    </a>
                </div>
                <div class={classes!("bg-[#ebebeb]", "pt-28",)}>
                    <div class={classes!("text-not-quite-black")}>
                    ...
                    <ul class={classes!("flex", "justify-center", "items-center", "gap-0", "pt-20", "pb-20", "flex-wrap", "max-w-5xl", "m-auto",)}>
